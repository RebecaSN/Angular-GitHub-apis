...
export class GhHomeComponent implements OnInit {
  ...
  showDialog():void{
    ...
    ref.componentInstance.usarname=this.usernameToFind.value
  }//a partir dela, posso passar os valores da prorpiedade, o valor que ta dentro do formulário ta vindo para a variavel do meu component
